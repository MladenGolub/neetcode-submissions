...
public:
    ...
    bool dfs(int course) {
        if(visited.find(course) != visited.end()) return false;//!!!!! NAJBITNIJE U OVOM ZADATKU JE PRACENJE DA LI SE NALAZIMO U PETLJI ZA ODREDJENU POLAZNU TACKU, JER PREKO TOGA ZNAMO DA LI MOZEMO
